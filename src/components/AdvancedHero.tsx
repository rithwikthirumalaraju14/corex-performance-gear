...
const AdvancedHero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-40 right-20 w-3 h-3 bg-corex-blue rounded-full animate-float opacity-60" style={{ animationDelay: '1s' }}></div>
      <div className="absolute bottom-40 left-20 w-1 h-1 bg-corex-green rounded-full animate-float opacity-80" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="text-center max-w-4xl animate-fade-in">
          ...
          <div className="mb-8">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bebas tracking-wider mb-4 animate-scale-in">
              <span className="inline-block hover:text-corex-red transition-colors duration-300 cursor-default">C</span>
              <span className="inline-block hover:text-corex-blue transition-colors duration-300 cursor-default">O</span>
              <span className="inline-block hover:text-corex-green transition-colors duration-300 cursor-default">R</span>
              <span className="inline-block hover:text-corex-orange transition-colors duration-300 cursor-default">E</span>
              <span className="mx-4">•</span>
              <span className="inline-block hover:text-corex-purple transition-colors duration-300 cursor-default">X</span>
            </h1>
          </div>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button 
                  variant="outline" 
                  size="lg"
                  className="group border-white text-white hover:bg-white hover:text-black px-8 py-4 text-lg transform hover:scale-105 transition-all duration-300"
                >
